...
from aithru_agent.domain import AgentRunStatus, AgentSkill, AgentToolFailureKind, AgentWorkspacePolicy
...
async def test_workspace_tool_rejects_paths_outside_skill_allowed_paths() -> None:
    ...
    assert tool_failed.payload["recovery"]["kind"] == "invalid_input"
